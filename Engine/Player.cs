    ...
    private void UpdateCurrentBackground ()
    {
        switch (CurrentLocation.ID)
        {
            case World.LOCATION_ID_HOME:
                BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\Home.png";
                break;
            case World.LOCATION_ID_TOWN_SQUARE:
                BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\TownSquare.png";
                break;
            case World.LOCATION_ID_ALCHEMISTS_GARDEN:
                if (CompletedThisQuest(World.QuestByID(World.QUEST_ID_CLEAR_ALCHEMIST_GARDEN)))
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\HerbGarden.png";
                }
                else
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\Rats.png";
                }
                break;
            case World.LOCATION_ID_ALCHEMIST_HUT:
                if (CompletedThisQuest(World.QuestByID(World.QUEST_ID_CLEAR_ALCHEMIST_GARDEN)))
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\AlchemistReward.png";
                }
                else
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\AlchemyHut.png";
                }
                break;
            case World.LOCATION_ID_FARMHOUSE:
                if (CompletedThisQuest(World.QuestByID(World.QUEST_ID_CLEAR_FARMERS_FIELD)))
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\FarmerReward.png";
                }
                else
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\Farmer.png";
                }
                break;
            case World.LOCATION_ID_FARM_FIELD:
                if (CompletedThisQuest(World.QuestByID(World.QUEST_ID_CLEAR_FARMERS_FIELD)))
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\ConqueredSnakes.png";
                }
                else
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\Snakes.png";
                }
                break;
            case World.LOCATION_ID_BRIDGE:
                BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\StoneBridge.png";
                break;
            case World.LOCATION_ID_GUARD_POST:
                BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\GuardPost.png";
                break;
            case World.LOCATION_ID_SPIDER_FIELD:
                if (CompletedThisQuest(World.QuestByID(World.QUEST_ID_KILL_GIANT_SPIDER)))
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\SpiderDeath.png";
                }
                else
                {
                    BackgroundImagePath = @"C:\Users\set7250\LearningC#\SuperAdventure\SuperAdventure\Resources\SpiderForest.png";
                }
                break;
            default:

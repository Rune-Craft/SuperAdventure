...
public static class World
{
    ...
    private static void PopulateItems ()
    {
        ...
        Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 10, 5));
        ...
        Items.Add(new Weapon(ITEM_ID_KNIGHTS_SWORD, "Knight's sword", "Knight's swords", 10, 20, 20));
    }
